-- 双鱼座 Pisces
_G.piscesscene = class('piscesscene',basescene)

function piscesscene:onEnterScene()
    scenemgr:getInstance():transitionScene( function ()
        if g_option.DEBUG > 0 then 
            local c_title = title:new({ nTitleNameFontSize = 72, nVersionFontSize = 22, sTitleName = "双鱼座", 
