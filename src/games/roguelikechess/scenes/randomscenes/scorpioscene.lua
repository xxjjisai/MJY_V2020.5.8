-- 天蝎座 Scorpio
_G.scorpioscene = class('scorpioscene',basescene)

function scorpioscene:onEnterScene()
    scenemgr:getInstance():transitionScene( function ()
        if g_option.DEBUG > 0 then 
            local c_title = title:new({ nTitleNameFontSize = 72, nVersionFontSize = 22, sTitleName = "天蝎座", 
