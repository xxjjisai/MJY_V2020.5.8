...
-- print++
function trace(data,cstring,deepIndex)  --�ڶ�����������Ϊ�գ�������������Ҫ�ֶ����ӣ������������д�ӡ��ȿ��Ƶġ�
    if data == nil then   
    ...
    if(type(data)=="table") then  
        ...
        for k, v in pairs(data) do  
            if(type(v) == "table") then print(cs..tostring(k).." = ");
                ...
                if (deepIndex + 1) < 5 then  --5���ǿ��ƵĴ�ӡ���(����Ը�����Ҫ����)���Է����ݽṹ�д���ѭ������(����Ϊ�����ܣ��Ҿ�������)
